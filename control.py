...
def run(stop_needed, start_state, goal_state):
    ...
    # Initialize the path
    path = planner.a_star(curr_map_grid, [vehicle_x, vehicle_y], goal_state[0])
    ...
    while True:
        ...
        if encounter_obstacle():
            ...
            # Plan a new path
            path = planner.a_star(curr_map_grid, [current_state[0], current_state[1]], goal_state[0])
            print("@@@@@ Path:", path)
            path.pop(0)
    ...
    print("====================================")   
    path = planner.a_star(curr_map_grid, [current_state[0], current_state[1]], goal_state[1])
    print("@@@@@ Path:", path)
    path.pop(0)
    fc.servo.set_angle(0)
    while True:
